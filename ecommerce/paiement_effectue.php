			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<h1>Thankyou </h1>
						<hr/>
						<p>Hello <?php echo $_SESSION["name"]; ?>,paiement effectue avec
						success et votre id de transaction est <b></b><br/>
						vous pouvez continuer votre Shopping <br/></p>
						<a href="index.php" class="btn btn-success btn-lg">Continuer le Shopping</a>
					</div>
