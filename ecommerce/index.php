	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<div style="width:300px;">
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									...
									<p><br/></p>
									<a href="#" style="color:white; list-style:none;">mot de passe oublié</a><input type="submit" class="btn btn-success" style="float:right;" id="login" value="Connexion">
								</div>
				...
				<li><a href="inscription_client.php"><span class="glyphicon glyphicon-user"></span>Inscription</a></li>
			</ul>
		</div>
	</div>
</div>	
